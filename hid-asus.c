		...
		int *max)
{
	...
	if ((usage->hid & HID_USAGE_PAGE) == HID_UP_ASUSVENDOR) {
		...
		case 0x8a: asus_map_key_clear(KEY_KBDILLUMUP);		break;
		case 0x9e: asus_map_key_clear(KEY_KBDILLUMDOWN);		break;
		...
		case 0xb2: asus_map_key_clear(KEY_HOME);		break;

		/* Fn+Right Aura mode next on N-Key keyboard */
		case 0xb3: asus_map_key_clear(KEY_END);		break;
		
		case 0xc4: asus_map_key_clear(KEY_PAGEUP);		break;
		case 0xc5: asus_map_key_clear(KEY_PAGEDOWN);		break;
